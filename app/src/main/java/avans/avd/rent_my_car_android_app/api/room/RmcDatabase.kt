...
@Database(entities = [Car::class, Location::class], version = 2, exportSchema = false)
abstract class RmcDatabase : RoomDatabase() {
    ...
    abstract fun carDisplayDao(): CarDisplayDao
    ...
    companion object {
         ...
         */
        @Volatile
        private var INSTANCE: RmcDatabase? = null
         ...
         */
        fun getInstance(context: Context): RmcDatabase {
